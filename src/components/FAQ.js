    ...
    <div className='faq' id='faq' ref={ref}>
      ...
      <div className='accordion-container' ref={accRef}>
        ...
        <div className='ac pink'>
          ...
          <div className='ac-panel'>
            <p className=''><span className='text'>No, one does not need to be online for the entire duration. You can develop the application on your local system based on the given themes and then submit it on HackerEarth, on the specific challenge page.</span></p>
          </div>
        </div>
