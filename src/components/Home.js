...
const Home = ({ setActive, introRef, aboutRef, hackRef, visionRef, sponsorsRef, contactRef, faqRef, timelineRef }) => {
  ...
  useEffect(() => {
    const scrollFunc = () => {
      ...
      else if (offset <= (vision + timeline) / 2) setActive('vision')
    ...
    scrollFunc()
  }, [introRef, aboutRef, hackRef, visionRef, sponsorsRef, contactRef, faqRef, timelineRef, faq, offset, intro, about, setActive, hack, vision, sponsors, contact, timeline])
